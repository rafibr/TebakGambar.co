...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class=" align-items-center text-center">
                                <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Admin" class="rounded-circle" width="75">
                                <div class="mt-3">
                                    ...
                                    <div class="row text-left">
                                        <div class="col-sm-12">
                                            <a class="btn btn-info d-flex justify-content-center" target="__blank" data-toggle="modal" data-target="#modalEditPenebak">Edit</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            <a id="ss_dompet_parent" href="{{ url('storage/SSDompet/background.jpg') }}" data-toggle="lightbox" data-title="SS Dompet Digital" data-gallery="gallery">
                                                <img id="ss_dompet" src="{{ url('storage/SSDompet/background.jpg') }}" class="img-fluid mb-2" alt="SS Dompet Digital" />
                                            </a>
                                            <a class="btn btn-outline-info d-flex justify-content-center" target="__blank" data-toggle="modal" data-target="#modalEditSS">Ganti
                                                Gambar</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row mb-2 text-right ">
                                        <div class="col">
                                            ...
                                            <a id="btnModalTambah" class="btn btn-info justify-content-center" data-toggle="modal" data-target="#modalTambah">Tambah
                                                History</a>
                                        </div>
                                    </div>
                                    <div class="row justify-content-center">
                                        <div class="col-auto">
                                            <table id="tableHistory" class="display compact nowrap table table-sm table-responsive table-hover table-bordered table-striped">
                                                <thead>
                                                    <tr>
                                                        <th>No.</th>
                                                        <th>Epoch</th>
            ...
            <!-- Modal edit penebak -->
            <div class="modal fade" id="modalEditPenebak" role="dialog" aria-labelledby="modalEditPenebakTitle" aria-hidden="true">
                        ...
                        <form id="formEditPenebak" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="inputNama" class="form-control" id="inputNama" placeholder="Input Nama">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="inputAddress" class="form-control" id="inputAddress" placeholder="Input Idena Address"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputJenisPembayaran" class="col-sm-4 col-form-label">Jenis
                                        Pembayaran</label>
                                    <div class="col-sm-8">
                                        <select name="inputJenisPembayaran" class="form-control select2bs4" id="inputJenisPembayaran">
                                ...
                                <div class="form-group row">
                                    <label for="inputNoPembayaran" class="col-sm-4 col-form-label">No.
                                        Pembayaran</label>
                                    <div class="col-sm-8">
                                        <input type="number" name="inputNoPembayaran" class="form-control" id="inputNoPembayaran" placeholder="Input No.Pembayaran">
                                    </div>
                                </div>
                            </div>
                        ...
                        <form id="formEditSS" method="POST" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="imgupload" class="form-control" id="imgupload" accept="image/png, image/gif, image/jpeg">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
            ...
            <div class="modal fade" id="modalTambah" role="dialog" aria-labelledby="modalTambahTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        ...
                        <form id="formTambahHistory" method="POST">
                            <div class="modal-body">

                                <a href="#" class="btn btn-info d-flex justify-content-center mb-4" onclick="load_state()">Ambil
                                    Data</a>
                                <input type="hidden" class="idPenebak" id="idPenebak" name="idPenebak">
                                <div class="form-group row">
                                    <label for="inputEpoch" class="col-sm-4 col-form-label">Epoch</label>
                                    <div class="col-sm-8">
                                        <input type="number" name="inputEpoch" class="form-control" id="inputEpoch" placeholder="Input Epoch">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="inputAge" class="form-control" id="inputAge" placeholder="Input Age">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="inputTglValidasi" class="col-sm-4 col-form-label">Tanggal Validasi</label>
                                    <div class="col-sm-8">
                                        <select name="inputTglValidasi" class="form-control select2bs4" id="inputTglValidasi">
                                            <option disabled selected>Pilih Tanggal Validasi</option>
                                            @foreach ($dataValidasi as $m)

                                            <option value="{{ $m->id }}">{{ $m->tanggal_validasi }}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="inputPrevState" class="form-control" id="inputPrevState" placeholder="Input PrevState">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputState" class="col-sm-4 col-form-label">State</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="inputState" class="form-control" id="inputState" placeholder="Input State">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputNilai" class="col-sm-4 col-form-label">Nilai (%)</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="inputNilai" class="form-control" id="inputNilai" placeholder="Input Nilai">
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <button type="submit" form="formTambahHistory" class="btn btn-success">Simpan</button>
                            </div>
                        </form>
            ...
            {{-- TGL VALIDASI --}}
            TODO: modal edit dan delete, fungsi edit dan delete
            {{-- TGL VALIDASI /end --}}
